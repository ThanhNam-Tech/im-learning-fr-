...
<br><br>
<br><br>
## Lec 1.5 AI Solution Factors - 2 June 2025
...
### 🤔 Questions I Had
Okay, things sound cool, but can we actually create an AI system that works in all industries, like it has the ability to respond in 0.1 sec?  
...
## 1.6 Machine Learning - 2 June 2025
### 🔑 Key Takeaways
There are 3 types of machine learning algorithims : supervised learning, unsupervised learning, reinforcement learning.
### 📊 Real-World Examples
like in the medical industry, to classify people who are having diseases or not : 
 supervised learning : based on fed information, compared and filter endity with thier own information. 
 unsupervised learnin : they can classify people with their own statics, but can not state what are their deasees.
reinforcement learning : they dont actully based on input data, this machine do things itself, then recheck the output, compared and find the most proficient way.
### 🧠 Insights & Reflections
